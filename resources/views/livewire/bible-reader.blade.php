    ...
    <header
        ...
        <div class="h-16 px-4 flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <button wire:click="$toggle('sidebarOpen')" aria-label="Buka/tutup sidebar"
                    class="hidden md:inline-flex items-center justify-center w-11 h-11 rounded hover:bg-white/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70">
                ...
                <button wire:click="$toggle('mobileMenu')" aria-label="Buka/tutup menu"
                    class="md:hidden inline-flex items-center justify-center w-11 h-11 rounded hover:bg-white/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="1.5" class="w-5 h-5" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3.75 6.75h16.5M3.75 12h16.5M3.75 17.25h16.5" />
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('bible.search') }}"
                    class="px-3 py-2 rounded text-sm bg-[#213448] hover:bg-gray-500 dark:hover:bg-white/30 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70">
                    Cari Ayat
                </a>
            </div>
        </div>
                        ...
                        <li>
                            <button wire:click="selectBook({{ $book->no }})"
                                class="
                                    ...
                                    px-3 py-2 rounded min-h-[44px]
                                    hover:bg-gray-100 dark:hover:bg-white/10
                                    focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary
                                    transition
                                ">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="1.5" class="w-5 h-5 flex-shrink-0"
                                    aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                                </svg>
            ...
            <div class="p-6 max-w-3xl mx-auto">
                ...
                @if ($search)
                    <div class="text-sm text-gray-500 dark:text-gray-400 mb-3">
                        Pencarian: "{{ $search }}" — {{ count($verses) }} hasil
                    </div>
                @endif
                    ...
                    @if (count($verses) > $visibleCount)
                        <div class="pt-2 text-center">
                            <button wire:click="loadMore"
                                class="inline-flex items-center gap-1 px-4 py-2 text-sm rounded bg-gray-200 dark:bg-white/10 hover:bg-gray-300 dark:hover:bg-white/20 transition dark:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
